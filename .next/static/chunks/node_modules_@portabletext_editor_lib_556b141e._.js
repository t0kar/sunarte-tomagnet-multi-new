...
function getFocusBlock({ editor }) {
    return editor.selection ? Array.from(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].nodes(editor, {
...
const mutationMachine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setup"])({
    types: {
        context: {},
        events: {},
        input: {},
...
const converterJson = {
    ...
    deserialize: ({ snapshot, event })=>{
        const blocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["htmlToBlocks"])(event.data, snapshot.context.schema.portableText, {
...
`),
    ...
    deserialize: ({ snapshot, event })=>{
        const textToHtml = `<html><body>${escapeHtml(event.data).split(/\n{2,}/).map((line)=>line ? `<p>${line.replace(/(?:\r\n|\r|\n)/g, "<br/>")}</p>` : "<p></p>").join("")}</body></html>`, blocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["htmlToBlocks"])(textToHtml, snapshot.context.schema.portableText, {
            keyGenerator: snapshot.context.keyGenerator
        });
        return blocks.length === 0 ? {
            type: "deserialization.failure",
            ...
            if (selection) {
                ...
                if (range) {
                    if (!options?.mode || options?.mode === "selected") {
                        debug$a("Deleting content in selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].delete(editor, {
                            at: range,
                            hanging: !0,
                            voids: !0
                        }), editor.onChange();
                    ...
                    options?.mode === "blocks" && (debug$a("Deleting blocks touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
                    ...
                    })), options?.mode === "children" && (debug$a("Deleting children touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
...
const addAnnotationActionImplementation = ({ context, action })=>{
    ...
    const editor = action.editor;
    if (debug$a("Removing annotation", action.annotation.name), !!editor.selection) if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].isCollapsed(editor.selection)) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].blur(action.editor);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactEditor"].focus(action.editor);
...
function performAction({ context, action }) {
    switch(debug$9(JSON.stringify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$omit$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(action, [
        "editor"
    ]), null, 2)), action.type){
        case "annotation.add":
            {
...
function insertPatch(editor, patch, schemaTypes) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$8(`Inserting blocks at path [${normalizedIdx2}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(editor, blocksToInsert, {
            at: [
                normalizedIdx2
            ]
...
function unsetPatch(editor, patch) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$8(`Removing block at path [${blockIndex}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
            at: [
                blockIndex
            ]
        }), debugState(editor, "after"), !0;
        ...
        return editor.apply = (op)=>{
            ...
            if (op.type === "remove_node") {
                ...
                if (op.path[0] === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].isVoid(editor, node)) {
                    ...
                    editor.children[nextPath[0]] || (debug$6("Adding placeholder block"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].insertNode(editor, editor.pteCreateTextBlock({
                        decorators: []
                    })));
                }
            }
...
function useCreateInternalEditor(config) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$node_modules$2f$react$2d$compiler$2d$runtime$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6);
    let t0;
...
function getEventSelection({ schema, slateEditor, event }) {
    ...
    return range ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toPortableTextRange"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromSlateValue"])(slateEditor.children, schema.block.name), range, schema) : null;
}
...
const debug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["debugWithName"])("component:Editable"), PLACEHOLDER_STYLE = {
    ...
    }["PortableTextEditable.useSelector[schemaTypes]"]), slateEditor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$node_modules$2f$slate$2d$react$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSlate"])(), blockTypeName = schemaTypes.block.name;
            ...
            if (rangeDecorations && rangeDecorations.length > 0) {
                ...
                if (rangeDecorations.forEach({
                    "PortableTextEditable.useCallback[syncRangeDecorations]": (rangeDecorationItem)=>{
                        const slateRange_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toSlateRange"])(rangeDecorationItem.selection, slateEditor);
    ...
    const handleCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        ...
        "PortableTextEditable.useCallback[handlePaste]": (event_1)=>{
            const value_0 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PortableTextEditor"].getValue(portableTextEditor), path = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toPortableTextRange"])(value_0, slateEditor.selection, schemaTypes)?.focus.path || [], onPasteResult = onPaste?.({
                event: event_1,
                value: value_0,
                path,
                schemaTypes
    ...
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        ...
        "PortableTextEditable.useCallback[decorate]": ([, path_0])=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isEqualToEmptyEditor"])(slateEditor.children, schemaTypes)) return [
                {
                    anchor: {
                        path: [
                            0,
            ...
            }["PortableTextEditable.useCallback[decorate].result_2"]);
